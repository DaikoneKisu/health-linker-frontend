				...
				<div>
					...
					<IonPicker>
						<IonPickerColumn value="esp">
							...
							<IonPickerColumnOption value="esp">
								Enfermero especialista
							</IonPickerColumnOption>
							<IonPickerColumnOption value="ped">
								Médico pediatra
							</IonPickerColumnOption>
							<IonPickerColumnOption value="int">
								Médico internista
							</IonPickerColumnOption>
							<IonPickerColumnOption value="obs">
								Médico obstetra
							</IonPickerColumnOption>
							<IonPickerColumnOption value="psc">
								Psicólogo
							</IonPickerColumnOption>
							<IonPickerColumnOption value="ntr">
								Nutricionista
							</IonPickerColumnOption>
							<IonPickerColumnOption value="fsi">
								Fisioterapeuta
							</IonPickerColumnOption>
						</IonPickerColumn>
					</IonPicker>
